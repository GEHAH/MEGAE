...
from data.dataset_sys import Pretrain_VQ_Dataset,load_dataset,collate
	...
	for epoch in range(1, param["epoch"] + 1):
		...
		if epoch % 1 == 0:
			...
			if es >= patience:
				...
				outFile = open('PerformMetrics_Metrics_sys_14.csv', 'a+', newline='')
...
if __name__ == "__main__":
	...
	with open('config/train_ppi_sys.yaml') as f:
